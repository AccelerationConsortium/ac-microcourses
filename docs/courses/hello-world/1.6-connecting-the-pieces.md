...
*Workflow diagram showing how core pieces connect together in the "Hello World" light-mixing demo. Note that AWS Lambda is now used as an intermediate layer between the microcontroller and MongoDB (not shown).*
...
✅ Review your knowledge checks at https://q.utoronto.ca/.
